export default function Footer() {
    return (
        <footer className="bg-black text-white pt-20 pb-32 md:py-20 px-6 border-t border-neutral-800">
            <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-12">
                <div className="col-span-2">
                    <h2 className="text-5xl md:text-8xl font-bold tracking-tighter mb-8">CAFETRIKE.ID</h2>
